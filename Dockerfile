...
RUN wget http://apache.mirror.anlx.net/tomcat/tomcat-8/v8.5.61/bin/apache-tomcat-8.5.61.tar.gz -O /tmp/apache-tomcat-8.5.61.tar.gz
#ADD ./apache-tomcat-8.5.61.tar.gz /tmp/apache-tomcat-8.5.61.tar.gz
RUN tar xvf /tmp/apache-tomcat-8.5.61.tar.gz -C /opt/tomcat --strip-components=1
RUN rm -f /tmp/apache-tomcat-8.5.61.tar.gz
